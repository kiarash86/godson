#include "../../../include/model/abilities/selfHit.h"
...
void selfHit::excute(std::vector<card *> &Team, std::vector<card *> &enemy, int tagetIndex)
{
    attackChosenTeammate(chooseRandomTeammate(Team));
    healmyself();
}