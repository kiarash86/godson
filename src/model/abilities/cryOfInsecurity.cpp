#include "../../../include/model/abilities/cryOfInsecurity.h"
...
void cryOfInsecurity::excute(std::vector<card *> &Team, std::vector<card *> &enemy, int tagetIndex)
{
    attackChosenEnemy(chooseRandomEnemy(enemy));
    attackMyTeammates(Team);
}